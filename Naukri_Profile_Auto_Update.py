...
def test_login_and_edit_Naukri_Profile(page: Page):
    ...
    page.get_by_placeholder("Enter your active Email ID / Username").fill("uday.voyager1@gmail.com")
    page.get_by_placeholder("Enter your password").fill("loveumom@infinity")
